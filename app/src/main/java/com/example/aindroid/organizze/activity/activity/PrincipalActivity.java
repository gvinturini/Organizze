...
import com.example.aindroid.organizze.activity.adapter.AdapterMovimentacao;
...
public class PrincipalActivity extends AppCompatActivity {
    ...
    private FirebaseAuth autenticacao = ConfigFirebase.getAuth();
    ...
    public void excluirMovimentacao(final RecyclerView.ViewHolder viewHolder){
        ...
        alertDialog.setMessage("Você tem certeza que deseja excluir a movimentação da sua conta?");
